      ...
      <div className="relative z-10 container mx-auto px-4 md:px-6 text-center">
        ...
        >
          ...
          <div className="inline-block group relative cursor-pointer">
            <Button
              variant="ghost"
              className="relative z-10 rounded-2xl text-lg px-8 py-6 bg-foreground/5 hover:bg-foreground/10 backdrop-blur-sm border border-border transition-all duration-300"
            >
